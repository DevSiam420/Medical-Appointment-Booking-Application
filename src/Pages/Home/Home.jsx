...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-slate-950 via-slate-950 to-slate-950 overflow-x-hidden">
      ...
      <main className="relative pb-12 sm:pb-16 lg:pb-20">
        ...
        <section className="mt-8 sm:mt-12 px-3 sm:px-4 md:px-6 max-w-7xl mx-auto">
          <div className="relative rounded-[1.75rem] sm:rounded-[2rem] border border-white/5 bg-slate-950/60 backdrop-blur-xl shadow-[0_18px_80px_rgba(15,23,42,1)]">
